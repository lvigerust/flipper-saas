<div class="mx-auto pb-16 pt-20 text-center lg:pt-32">
	...
	>
		Accounting <span class="relative whitespace-nowrap text-pink-500">made simple</span> for small businesses.
	</h1>
	<p class="mx-auto mt-6 max-w-2xl text-lg tracking-tight">
		Most bookkeeping software is accurate, but hard to use. We make the opposite trade-off, and hope
		you don't get audited.
	</p>
	<div class="mt-10 flex justify-center gap-x-6">
		<a
			class="group inline-flex items-center justify-center rounded-full px-4 py-2 text-sm font-semibold text-white"
			href="#">Get 6 months free</a
		>
